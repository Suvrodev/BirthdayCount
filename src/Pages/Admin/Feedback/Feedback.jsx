...
const Feedback = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_fup4rjf', 'template_aovt5cz', form.current, '_kzTXrFfQk2uFNUe9')
          .then((result) => {
              console.log(result);
    ...
    <div>
      <div className="border-white border-2 m-2 p-5 rounded-xl w-8/12 mx-auto">
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <input className="w-full p-4 rounded-md my-4" type="email" name="user_email" placeholder="Write Your Mail" /> <br />
          <label>Feedback</label> <br />
          <textarea className="w-full h-[125px] p-4 rounded-md my-4 resize-none" name="message" placeholder="Write Message" /> <br />
