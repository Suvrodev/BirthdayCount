        ...
        <div className='bg-purple-300 border-black border-1 rounded-lg m-5 p-4'>
                ...
                <div className='hereForm  '>
                   ...
                   <form action="" onSubmit={handleRegistration} className='w-[80%] mx-auto'>
                        ...
                        <input className='w-[100%] p-2 mx-auto text-white border-0 outline-none' type="text" name="name"  placeholder='Enter your Name' required/>
                        ...
                        <input type="file" className="file-input file-input-bordered w-full " name="photo" required />


                        <p className='font-bold my-4'>Email Address</p>
                        <input className='w-[100%] p-2 mx-auto text-white border-0 outline-none' type="email" name="email"  placeholder='Enter your email address' required/>
                        <p className='font-bold my-4'>Password</p>
                        <div className='relative'>
                            <input className='w-[100%] p-2 mx-auto text-white border-0 outline-none' type={showPassword? "text" : "password"} name="password"  placeholder='Enter your Password' required/>
                        ...
                        <div className='relative'>
                            <input className='w-[100%] p-2 mx-auto text-white border-0 outline-none' type={showConfirmPassword? "text" : "password"} name="Cpassword"  placeholder='Retype Password' required/>
                        ...
                        <p className='text-center mt-2'>Already Have An Account ? <Link to={'/login'} className='text-red-500 font-bold'>Login</Link></p>
                   </form>
                </div>
            </div>
    );
